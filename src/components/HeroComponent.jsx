                        ...
                        <div className="relative w-full lg:w-1/2 text-right pt-8 lg:pt-12">
                            ...
                            <div className="flex items-start justify-center sm:justify-end gap-4 mb-5 lg:mb-6">
                                <h1 className="text-[30px] sm:!text-[35px] justify-center flex items-end flex-col !font-bold !text-[#313033] whitespace-pre-line">
                                    <div className="bg-[#FDF9F2] h-[45px] flex items-center justify-center w-fit p-2 border-[#EDE8DF] border rounded-[10px]">
                                        هر مشتری = چند خرید
                                    </div>
                                </h1>

                                <div className="w-[5px] h-[45px] bg-[#FFAD64] flex-shrink-0 rounded"></div>
                            </div>
                            ...
                            <a
                                href="#contact"
                                className="relative flex mx-auto sm:mx-[unset] items-center h-[50px] w-[185px] justify-center gap-3 lg:py-4 bg-[#B68E5D] text-white text-sm lg:text-base font-medium rounded-xl hover:bg-[#A68B6F] transition-colors shadow-lg"
                            >
